...
! cloud ice
real(r8), public :: ai = huge(1.0_r8)                    !Fall speed parameter for cloud ice (micro_p3_utils_init should assign it a valid value)
...
! arguments.
subroutine micro_p3_utils_init( kind, rh2o, cpair, tmelt_in, latvap, &
     latice, ice_sed_ai, errstring)
