...
contains
  ...
  select case(name)
    ...
    case ('phi','geo');       call get_phi(elem,dp,field,phi_i,hvcoord,nt,ntQ)
  ...
  end subroutine get_nonhydro_pressure



  subroutine get_phi(elem,dp,phi,phi_i,hvcoord,nt,ntQ)
    implicit none
